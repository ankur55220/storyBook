...
function Othersprofile() {
  ...
  useEffect(()=>{
    ...
    console.log(loggedUser,"jjjjj000000")
  ...
  return (
    <PageWrapperFullScreen>
        <Sidebar type="Othersprofile" userId={id} loading={loggedUser.loading} error={loggedUser.err} user={loggedUser.loggedInUser.user}/>
        <Container 
